...
const WavySeparator = () => (
    <svg width="40" height="20" viewBox="0 0 40 20" fill="none" className="mx-6 inline-block">
        <path d="M0 10 Q 10 0, 20 10 Q 30 20, 40 10" stroke="black" strokeWidth="3" fill="none" />
    </svg>
)
            ...
            <div className="max-w-6xl mx-auto px-6 pb-16 pt-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    {events.map((event, index) => (
                        <div key={index} className="text-center text-black bg-black/10 backdrop-blur-sm rounded-2xl p-6 md:p-8">
