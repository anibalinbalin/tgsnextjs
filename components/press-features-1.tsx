...
const pressItems = [
    ...
    },
    {
        ...
        publication: <>Guru<span style={{ fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' }}>&apos;</span>guay</>,
                    ...
                    {pressItems.map((item, index) => (
                        <Card key={index} className="group shadow-zinc-950/5 flex flex-col h-full text-center bg-white overflow-hidden pt-0">
                            ...
                            <CardContent className="flex flex-col flex-grow">
                                ...
                                <p className="text-gray-500 mb-6">{item.location}, {item.date}</p>
                                <div className="mt-auto">
                                    ...
                                    >
                                        <a href={item.url} target="_blank" rel="noopener noreferrer">
                                            Read Here{item.signUpRequired && ' [Sign-Up Required]'}
                                        </a>
                                    </Button>
                                </div>
                            </CardContent>
