        ...
        <section className="relative h-[50rem] overflow-hidden">
            ...
            <div className="relative z-10 @container mx-auto max-w-5xl px-6 h-full flex items-center justify-center">
                <div className="text-center space-y-8">
                    <h2 className="text-5xl md:text-6xl lg:text-7xl text-balance text-white font-medium">Our <span style={{ fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' }}>'</span>soft landing<span style={{ fontFamily: 'var(--font-geist-sans), system-ui, sans-serif' }}>'</span> programme sets relocating students up for success.</h2>
                    <div className="flex justify-center">
                        ...
                        >
                            <Link href="/softlanding">Learn about our Soft Landing</Link>
                        </Button>
                    </div>
                </div>
            </div>
