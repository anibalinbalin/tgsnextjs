...
export default function WelcomePage() {
    return (
        <>
            <div className="relative h-[70vh] bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/assets/ourschool/0_welcome/IMG_9439.jpg)' }}>
            ...
            <section className="relative py-16 md:py-32 bg-white">
                <div className="mx-auto max-w-5xl px-6">
                    <div className="mx-auto max-w-4xl space-y-6 text-justify">
                        <h2 className="text-balance text-left text-heading-empowering">
                        ...
                        <div className="mt-12">
                            <img
                                src="/assets/ourschool/0_welcome/signatures.png"
